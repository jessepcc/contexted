# Dogfood Report: Contexted Invite Flow (mock-backed local)

| Field | Value |
|-------|-------|
| **Date** | 2026-03-09 |
| **App URL** | http://127.0.0.1:4176/?invite=ALPHA123 |
| **Session** | contexted-invite-flow |
| **Scope** | Private invite landing → login → verify → app gateway → waiting room, using local web app with temporary mock API because local Supabase/LLM runtime secrets are empty |
...
1. Navigate to http://127.0.0.1:4176/?invite=ALPHA123
